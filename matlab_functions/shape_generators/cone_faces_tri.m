function [element_loc, element_norm] = cone_faces_tri(R, H, N_faces, dx, d_edge, z_max)
%CONE_FACES_TRI Generate a faced conical array with a triangular topology
%   [element_loc, element_norm] = cone_faces_tri(R, H, N_faces, dx, d_edge, z_max)
